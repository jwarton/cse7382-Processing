class Box {
  ...
  Box(Vec3 pos, float dim) {   
    ...
    faces[1] = new Face (verts[2],verts[3],verts[0]);
    faces[2] = new Face (verts[3],verts[2],verts[6]);
    faces[3] = new Face (verts[6],verts[7],verts[3]);
    ...
    faces[8] = new Face (verts[2],verts[1],verts[5]);
    faces[9] = new Face (verts[5],verts[6],verts[2]);
